...
/*   Updated: 2017/02/16 07:40:15 by bslakey          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define RED(text) "\x1b[31m" text COLOR_RESET
# define BLUE(text)  "\x1b[34m" text COLOR_RESET
# define GREEN(text) "\x1b[32m" text COLOR_RESET
